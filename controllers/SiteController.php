...
class SiteController extends Controller
{
    ...
    public function actionKeys()
    {
        ...
        if ($form_model->load(Yii::$app->request->post())) {
            ...
            $words = ["Берег","Таможня","Завод","Лес","Все ключи", "3-х этажная общага на Таможне", "2-х этажная общага на Таможне", "Восточное крыло санатория", "Западное крыло санатория", "Ключи от санатория на Берегу", "Ключи от техники", "Квестовые ключи", "Ключи от сейфов/помещений с сейфами"];
