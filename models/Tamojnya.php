...
use app\models\queries\TamojnyaQuery;
...
/**
 * This is the model class for table "tamojnya".
 *
 * @property integer $id
 ...
 */
class Tamojnya extends ActiveRecord
{
     ...
     *
     * @return TamojnyaQuery
     */
    public static function find(): TamojnyaQuery
    {
        /** Каждой AR модели свой класс ActiveQuery */
        return new TamojnyaQuery(get_called_class());
    }
}