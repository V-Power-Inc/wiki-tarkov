...
![Stable Version](https://img.shields.io/badge/version-v2.9.1-brightgreen)
...
![Tests Code Coverage](https://img.shields.io/badge/coverage-71%25-yellowgreen)
...
## Snyk анализатор кода (Фишка битбакет)
Т.к. проект отныне позиционируется как серьезный, была произведена интеграция Bitbucket со Snyk анализатором кода. Это позволяет проверять каждый коммит на наличие возможных уязвимостей.
...
- https://bitbucket.org/PC_Principal/eft-locations-map (Основная разработка)
- https://github.com/PC-Principal/wiki-tarkov
