...
![Stable Version](https://img.shields.io/badge/version-v4.8.71-brightgreen)
![Stable branch](https://img.shields.io/badge/Stable%20branch-master-success)
![Tests Count](https://img.shields.io/badge/tests%20count-848-informational)
![Tests Code Coverage](https://img.shields.io/badge/coverage-95%25-yellowgreen)
...
В проекте реализовано функциональное и Unit тестирование с использованием Codeception. Всего написано 196 методов тестирования с 889 ожиданиями определенных результатов. В процессе тестирования использовались фикстуры для баз данных, как независимые, так и взаимосвязанные.
...
- Gitlab - недоступен на момент создания ссылок, там проект тоже есть.