...
![Stable Version](https://img.shields.io/badge/version-v6.1.12-brightgreen)
![Stable branch](https://img.shields.io/badge/Stable%20branch-master-success)
![Tests Count](https://img.shields.io/badge/tests%20count-792-informational)
![Tests Code Coverage](https://img.shields.io/badge/coverage-93%25-yellowgreen)
...
В проекте реализовано функциональное и Unit тестирование с использованием Codeception. Всего написано 792 теста тестирования. В процессе тестирования использовались фикстуры для баз данных, как независимые, так и взаимосвязанные.
...
Запуск Unit тестов возможен стандартной командой в корневой директории проекта, однако - чтобы не было проблем рекомендуется сперва очистить кеш Redis:
...
Вышеупомянутый функционал составляет примерно 93% проекта (не считая админки).
