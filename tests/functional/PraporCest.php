...
class PraporCest
{
    ...
    {
        $I->seeInSource('<meta name="description" content="Прохождение и разбор квестов Прапора по онлайн-шутеру Escape from Takov.">');
        $I->seeInSource('<meta name="keywords" content="Квесты прапора в Escape from Tarkov, квесты прапор Тарков">');
    }
    ...
    public function checkOpengraphTagsData(\FunctionalTester $I)
    {
        ...
        $I->seeInSource('<meta property="og:title" content="Квесты Прапора в Escape from Tarkov. Разбор и прохождение квестов Прапора.">');
    ...
    {
        $I->seeInTitle('Квесты Прапора в Escape from Tarkov. Разбор и прохождение квестов Прапора.');
    }
