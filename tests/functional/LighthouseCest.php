...
/**
 * Функциональные тесты интерактивной карты Маяк
 *
 * Class LighthouseCest
...
class LighthouseCest
{
    ...
    {
        $I->amOnRoute(MapsController::routeId(MapsController::ACTION_LIGHTHOUSE));
    }
    ...
    {
        $I->seeInSource('<meta name="description" content="Интерактивная карта локации Маяк из игры Escape from Tarkov.">');
    }
    ...
    public function checkOpengraphTagsData(\FunctionalTester $I)
    {
        ...
        $I->seeInSource('<meta property="og:title" content="Карта локации Маяк в Escape from Tarkov.">');
    ...
    {
        $I->seeInTitle('Карта локации Маяк в Escape from Tarkov.');
    }
    ...
    {
        $I->see('Карта локации Маяк', 'h1');
        $I->see('Интерактивная карта локации Маяк', 'h2');
    }
