...
class LabyrinthCest
{
    ...
    {
        $I->amOnRoute(MapsController::routeId(MapsController::ACTION_LABYRINTH));
    }
    ...
    {
        $I->seeInSource('<meta name="description" content="Интерактивная карта локации Лабиринт из игры Escape from Tarkov">');
    }
