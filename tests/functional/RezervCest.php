...
class RezervCest
{
    ...
    {
        $I->amOnRoute(MapsController::routeId(MapsController::ACTION_REZERV));
    }
    ...
    {
        $I->seeInSource('<meta name="description" content="Интерактивная карта локации Резерв из игры Escape from Tarkov">');
    }
    ...
    public function checkOpengraphTagsData(\FunctionalTester $I)
    {
        ...
        $I->seeInSource('<meta property="og:title" content="Карта локации Резерв в Escape from Tarkov">');
    ...
    {
        $I->seeInTitle('Карта локации Резерв в Escape from Tarkov');
    }
    ...
    public function checkPageMainData(\FunctionalTester $I)
    {
        ...
        $I->see('Интерактивная карта локации Резерв', 'h2');
    }
