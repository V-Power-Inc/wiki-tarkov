...
/**
 * Функциональные тесты интерактивной карты Лаборатории Terra Group
 *
 * Class LaboratoryCest
...
class LaboratoryCest
{
    ...
    {
        $I->amOnRoute(MapsController::routeId(MapsController::ACTION_LABORATORYTERRA));
    }
    ...
    {
        $I->seeInSource('<meta name="description" content="Интерактивная карта локации лаборатория Terra Group из игры Escape from Tarkov с маркерами расположения военных ящиков, спавнов диких и ЧВК, дверей открываемых ключами.">');
    }
    ...
    public function checkOpengraphTagsData(\FunctionalTester $I)
    {
        ...
        $I->seeInSource('<meta property="og:title" content="Карта локации лаборатория Terra Group в Escape from Tarkov - интерактивная карта со спавнами Диких, точками военных ящиков и ключей">');
