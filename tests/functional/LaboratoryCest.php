...
class LaboratoryCest
{
    ...
    public function checkOpengraphTagsData(\FunctionalTester $I)
    {
        ...
        OpengraphChecker::checkTags($I, 'Карта локации лаборатория Terra Group в Escape from Tarkov - интерактивная карта со спавнами Диких, точками военных ящиков и ключей');
    }
