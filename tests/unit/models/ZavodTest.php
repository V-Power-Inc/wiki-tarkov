...
class ZavodTest extends \Codeception\Test\Unit
{
    ...
    public function testSelectActiveChvkExitsRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_EXITS_GROUP => 'ЧВК зона'])
            ->all();
    ...
    public function testSelectActiveDikieExitsRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_EXITS_GROUP => 'Диких зона'])
            ->all();
    ...
    public function testSelectActiveWithCustomIconRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere(['is not', Zavod::ATTR_CUSTOMICON, null])
            ->all();
    ...
    public function testSelectActiveWithoutCustomIconRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere(['is', Zavod::ATTR_CUSTOMICON, null])
            ->all();
    ...
    public function testSelectActiveWithExitsAnywayRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_EXIT_ANYWAY => 1])
            ->all();
    ...
    public function testSelectActiveWithoutExitsAnywayRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_EXIT_ANYWAY => 0])
            ->all();
    ...
    public function testSelectActiveWithExitsRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_MARKER_GROUP => 'Маркеры выходов'])
            ->all();
    ...
    public function testSelectActiveWithArmyLootRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_MARKER_GROUP => 'Военные ящики'])
            ->all();
    ...
    public function testSelectActiveWithInterestingPlacesRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_MARKER_GROUP => 'Интересные места'])
            ->all();
    ...
    public function testSelectActiveWithDikieSpawnsRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_MARKER_GROUP => 'Спавны диких'])
            ->all();
    ...
    public function testSelectActiveWithChvkSpawnsRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_MARKER_GROUP => 'Спавны игроков ЧВК'])
            ->all();
    ...
    public function testSelectActiveWithQuestsRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_MARKER_GROUP => 'Квестовые точки'])
            ->all();
    ...
    public function testSelectActiveWithKeysRows()
    {
        ...
        $list = Zavod::find()
            ->where([Zavod::ATTR_ENABLED => 1])
            ->andWhere([Zavod::ATTR_MARKER_GROUP => 'Маркеры ключей'])
            ->all();
