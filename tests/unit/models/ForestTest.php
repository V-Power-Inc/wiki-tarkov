...
class ForestTest extends \Codeception\Test\Unit
{
    ...
    public function testSelectActiveChvkExitsRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_EXITS_GROUP => 'ЧВК зона'])
            ->all();
    ...
    public function testSelectActiveDikieExitsRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_EXITS_GROUP => 'Диких зона'])
            ->all();
    ...
    public function testSelectActiveWithCustomIconRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere(['is not', Forest::ATTR_CUSTOMICON, null])
            ->all();
    ...
    public function testSelectActiveWithoutCustomIconRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere(['is', Forest::ATTR_CUSTOMICON, null])
            ->all();
    ...
    public function testSelectActiveWithExitsAnywayRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_EXIT_ANYWAY => 1])
            ->all();
    ...
    public function testSelectActiveWithoutExitsAnywayRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_EXIT_ANYWAY => 0])
            ->all();
    ...
    public function testSelectActiveWithExitsRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_MARKER_GROUP => 'Маркеры выходов'])
            ->all();
    ...
    public function testSelectActiveWithArmyLootRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_MARKER_GROUP => 'Военные ящики'])
            ->all();
    ...
    public function testSelectActiveWithInterestingPlacesRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_MARKER_GROUP => 'Интересные места'])
            ->all();
    ...
    public function testSelectActiveWithDikieSpawnsRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_MARKER_GROUP => 'Спавны диких'])
            ->all();
    ...
    public function testSelectActiveWithChvkSpawnsRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_MARKER_GROUP => 'Спавны игроков ЧВК'])
            ->all();
    ...
    public function testSelectActiveWithQuestsRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_MARKER_GROUP => 'Квестовые точки'])
            ->all();
    ...
    public function testSelectActiveWithKeysRows()
    {
        ...
        $list = Forest::find()
            ->where([Forest::ATTR_ENABLED => 1])
            ->andWhere([Forest::ATTR_MARKER_GROUP => 'Маркеры ключей'])
            ->all();
