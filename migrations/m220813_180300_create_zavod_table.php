...
/**
 * Handles the creation of table `{{%zavod}}`.
 */
class m220813_180300_create_zavod_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addCommentOnTable(static::TABLE_NAME, "В этой таблице хранятся маркеры локации Завод");
    }
