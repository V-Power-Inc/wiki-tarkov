...
/**
 * Handles the creation of table `{{%razvyazka}}`.
 */
class m220813_181842_create_razvyazka_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addCommentOnTable(static::TABLE_NAME, "В этой таблице хранятся маркеры локации Развязка");
    }
