...
/**
 * Handles the creation of table `{{%mehanic}}`.
 */
class m220813_180209_create_mehanic_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addCommentOnTable(static::TABLE_NAME, "В этой таблице хранятся квесты Механика");
    }
