...
/**
 * Handles the creation of table `{{%lyjnic}}`.
 */
class m220813_175656_create_lyjnic_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addCommentOnTable(static::TABLE_NAME, "В этой таблице хранятся квесты Лыжника");
    }
