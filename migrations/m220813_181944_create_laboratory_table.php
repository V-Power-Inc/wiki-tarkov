 ...
 */
class m220813_181944_create_laboratory_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addCommentOnTable(static::TABLE_NAME, "В этой таблице хранятся маркеры локации Лаборатирия TerraGroup");
    }
