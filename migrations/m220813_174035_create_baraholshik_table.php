...
/**
 * Handles the creation of table `{{%baraholshik}}`.
 */
class m220813_174035_create_baraholshik_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addCommentOnTable(static::TABLE_NAME, "В этой таблице хранятся квесты Барахольщика");
    }
