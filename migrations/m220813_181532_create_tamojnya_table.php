...
/**
 * Handles the creation of table `{{%tamojnya}}`.
 */
class m220813_181532_create_tamojnya_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addCommentOnTable(static::TABLE_NAME, "В этой таблице хранятся маркеры локации Таможня");
    }
