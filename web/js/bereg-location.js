...
$(document).ready(function() {
    ...
    $.each(markersData, function(i) {
        if (markersData[i].exit_anyway == "1" && markersData[i].exits_group !== '') {
            ...
            L.marker([markersData[i].coords_x, markersData[i].coords_y], {icon: ExitsIcon}).bindPopup(markersData[i].content).on('click', markerOnClick).openPopup().setZIndexOffset(999).addTo(beregspawn);
            L.marker([markersData[i].coords_x, markersData[i].coords_y], {icon: ExitsIcon}).bindPopup(markersData[i].content).on('click', markerOnClick).openPopup().setZIndexOffset(999).addTo(villagespawn);
