...
/** URL до смены цветовой темы сайта */
const URL_THEME = '/change-layout';
...
$(document).ready(function() {
    ...
    $('.js-change-site-style').click(function() {
        ...
        /** Фиксируем цель в Яндекс метрике - Меняли цветовую тему сайта */
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                /** Если с бэка вернулась строка - светлая тема, включаем ее */
                if (response === 'light-theme') {
                ...
                } else if (response === 'dark-theme') { /** Если с бэка вернулась строка - темная тема, включаем ее */
                    ...
                    $('#custom_site_styles').after('<link id="dark_theme" href="/css/dark-theme.css?v=6.8.12" rel="stylesheet">');
                }
            }
        })
    });
