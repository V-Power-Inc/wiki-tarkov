...
final class TranslateService
{
    ...
    public static function bossesAlertInfo(string $boss_name): string
    {
        ...
        switch ($boss_name) {
            case 'Death Knight':
                return '<p class="alert alert-danger size-16">Отряд The Goons - <b>состоит из 3-х боссов а именно, Death Knight, Big Pipe и Birdeye</b> - это и есть боссы. Дополнительная свита может включать от 1-2х человек фракции отступники.</p>';
            case 'Глухарь':
                return '<p class="alert alert-danger size-16">Очень хорошо экипированный босс с очень опасной свитой - <b>не рекомендуется вступать в бой на ближних дистанциях.</b> Лучшим решением будет атаковать его на дальних дистанциях и не допускать его приближения к вам.</p>';
        }
