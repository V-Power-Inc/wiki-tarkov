    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <div class="static-description">
                ...
                <p class="maps-mobile-hidden-value">Интерактивная карта локации Развязка из Escape from Tarkov - на данной карте, вы сможете увидеть спавны и выходы за диких и ЧВК с локации Развязка, узнать о местонахождении оружейных и военных ящиков. </p>
                <p class="maps-mobile-hidden-value">Также с помощью интерактивной карты вы сможете узнать о местах спавна ключей от помещений и сейфов, которые спавнятся на карте Развязки. Интерактивная карта локации Развязка поможет вам очень быстро найти квестовые точки, на которых можно увидеть предметы, или места необходимые для выполнения квестов торговцев.</p>
                <p class="alert alert-info maps-mobile-hidden-value"><b>Наиболее полная интерактивная карта локации Развязка с маркерами точек.</b></p>
