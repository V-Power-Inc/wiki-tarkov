    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <div class="static-description">
                ...
                <p class="maps-mobile-hidden-value">Интерактивная карта локации лаборатория Terra Group из Escape from Tarkov - на данной карте, вы сможете увидеть спавны и выходы за диких и ЧВК с локации лаборатория Terra Group, узнать о местонахождении оружейных и военных ящиков. </p>
                <p class="maps-mobile-hidden-value">Также с помощью интерактивной карты вы сможете узнать о местах спавна ключей от помещений и сейфов, которые спавнятся на карте лаборатории Terra Group. Интерактивная карта локации лаборатория Terra Group поможет вам очень быстро найти квестовые точки, на которых можно увидеть предметы, или места необходимые для выполнения квестов торговцев.</p>
                <p class="maps-mobile-hidden-value">В отличие от других карт - локация Terra Group разделена на несколько этажей или секторов, что делает ее довольно необычной и неповторимой, эта схема будет полезная игрокам ЧВК и диким, которые хотят выбраться из лаборатории живыми.</p>
