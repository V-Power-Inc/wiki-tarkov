...
<script type="text/javascript">
    ...
    var result = MD5(current_date);
    
    $('body').addClass(result);
    $('.container, .row, .col-lg-12').addClass(result);
    
    function CheckingUser() {
        $('body').before('<div class="'+result+'"><div class="'+result+'"><div class="col-lg-12 text-center '+result+'"><h2 class="main-site-heading '+result+'" style="font-weight: bold;">Вы используете блокировщик рекламы</h2><p style="font-size: 16px; margin: 20px 0 0 0;" class="'+result+'">Для того чтобы продолжить использование сайта, отключите блокировщик рекламы на страницах нашего сайта. <br><br> <b>Сайт не может существовать без доходов с показа рекламы.</b> <br><br> Очень надеемся на ваше понимание - команда Tarkov-wiki.ru</p> <button class="btn btn-primary rfr-page '+result+'" style="margin: 25px 0 0 0;" onclick="yaCounter47100633.reachGoal(\'close-refresh\');">Отключил! Обновить страницу</button> </div></div></div>');
