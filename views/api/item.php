    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 keys-content api-item-detail" data-item-id="<?= $item->json[ItemAttributes::ATTR_ITEM_ID] ?>">
            ...
            <div class="col-xs-3">
                ...
                <a class="image-link" title="<?= $item->name ?>" href="<?= AbstractItemsApiService::setupImageWithCheckingUrl($item->url, $item->json[ItemAttributes::ATTR_INSPECT_IMAGE_LINK]) ?>">
                    <img class="detail-item-image image-link" src="<?= AbstractItemsApiService::setupImageWithCheckingUrl($item->url, $item->json[ItemAttributes::ATTR_INSPECT_IMAGE_LINK]) ?>" alt="<?= $item->name ?>">
                </a>
