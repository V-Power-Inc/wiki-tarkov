    ...
    <div class="col-lg-12">
        <div class="option-buttons">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 map_buttons">
                ...
                <p class="markers-on" id="tamojnya-show-all"><i class="fa fa-eye"></i>Показать все маркеры</p>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 map_buttons">
                ...
                <p class="markers-off" id="tamojnya-hide-all"><i class="fa fa-eye-slash"></i>Скрыть все маркеры</p>
            </div>
        </div>
        <!-- Контент страницы -->
        <div class="col-lg-12">
