...
$this->title = 'Карта локации Лес в Escape from Tarkov - интерактивная карта Леса с маркерами';
    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            <div class="static-description">
                ...
                <p>Интерактивная карта локации Лес из игры Escape from Tarkov с маркерами спавнов диких, игроков ЧВК а также месторасположем военных ящиков, выходов с локации, дверей открываемых ключами и офисных ящиков.</p>
