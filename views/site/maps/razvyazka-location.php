...
<div class="optins_layerstability">
    ...
    <div class="col-lg-12">
        <div class="option-buttons">
            <!-- todo: Включить, когда будет доступная официальная карта -->
...
<!--                </div>-->
        ...
        <div class="col-lg-12">
            ...
            <div class="static-description">
                ...
                <p>На данном варианте карты <b style="color:#c3392c;">маркеры реализованы не будут</b>, т.к. <b style="color:#c3392c;">этот вариант карты не является окончательным</b>.</p>
                <p class="alert alert-danger"><b>Это не окончательный вариант карты - когда будет доступна официальная версия игровой карты, данный вариант будет обновлен.</b></p>
                <p></p>
