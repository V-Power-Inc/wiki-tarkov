...
$this->title = 'Квесты Смотрителя в Escape from Tarkov. Разбор и прохождение квестов Смотрителя.';
$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Прохождение и разбор квестов Смотрителя по онлайн-шутеру Escape from Takov.',
]);
...
<div class="heading-class">
    <div class="container">
        <h1 class="main-site-heading">Квесты Смотрителя</h1>
    </div>
</div>
